...
function Resume() {
  ...
  useEffect(() => {
    const fetchStudentData = async () => {
      try {
        const studentId = localStorage.getItem('resumeStudentId');
    ...
    <div className='resume'>
      {userData && (
        <>
          ...
          <h6><b>Objective:</b></h6>
          <p>A dynamic and enthusiastic BTech student seeking opportunities to apply academic knowledge and technical skills in a professional setting. Eager to contribute to [industry/field] through innovative problem-solving, collaboration, and continuous learning. Seeking a challenging role where I can utilize my passion for [specific area of interest] to contribute to the growth and success of the organization while gaining valuable experience and furthering my career development.</p>
